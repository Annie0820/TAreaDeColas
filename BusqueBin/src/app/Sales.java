...
public class Sales {
	...
	public void Menu()
	{
		...
		case 12:
			...
			break;
		default:
			System.out.println("¿Ves lo que hiciste? el programa explotó por tu culpa");
			break;
		}
	...
	private void Buscar(int[]vector){
		...
		if (posicion == -1) {
			...
			System.out.println("El valor de " + valor + " se encuentra en la posición: " + posicion + " del vector");
		}
	}
}
